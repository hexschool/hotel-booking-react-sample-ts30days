...
import { fetchCulinaryList, fetchNewsList, fetchRoom, fetchRoomList, loginGuard } from './apis/index.ts';
    ...
    children: [
      {
        path: '',
        loader: async () => {
          return Promise.all([ fetchNewsList(), fetchCulinaryList(), fetchRoomList() ]);
        },
        element: <Home />
      },
      {
